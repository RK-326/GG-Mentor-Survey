              ...
              create: [
                {
                  ...
                  label: "Мини-CRM «Менторские пары»",
                  description:
                    "Соберите небольшой, но цельный сервис: CRUD менторов и менти; пары «ментор ↔ менти» (один менти — не более одной активной пары, валидация на бэке); фиксация встреч; список пар с фильтрами; поиск по имени или email.\nСтек: FastAPI + PostgreSQL с миграциями + React, REST API с валидацией, запуск по README (можно docker-compose), внятная история коммитов.\nФормат: оплачиваемое, ориентир — рабочий день, дедлайн — 3 дня. Бонусы: тесты, Docker, CI, публичный деплой.",
                  type: "CONSENT",
                  required: false,
                  sortOrder: 0,
                  maxPoints: 0,
