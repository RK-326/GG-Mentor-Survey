              ...
              create: [
                {
                  ...
                  label: "Маленькое задание на код",
                  description:
                    "Небольшое задание, чтобы посмотреть на ваш код. Сделайте маленький REST API на FastAPI или Node.js: один ресурс с CRUD-операциями и валидацией входных данных, плюс короткий README «как запустить». База — по желанию (можно SQLite или in-memory).\nСдать: ссылку на репозиторий (GitHub / GitLab).\nЭто быстрое и простое задание, ориентир — 1–2 часа. Основное тестовое (Мини-CRM «Менторские пары») будет позже.",
                  type: "CONSENT",
                  required: false,
                  sortOrder: 0,
                  maxPoints: 0,
